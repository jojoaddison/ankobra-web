...
import { QuoteLineDeleteDialog } from './quote-line-delete-dialog';

describe('QuoteLine Management Delete Component', () => {
  let comp: QuoteLineDeleteDialog;
  let fixture: ComponentFixture<QuoteLineDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(QuoteLineDeleteDialog);
