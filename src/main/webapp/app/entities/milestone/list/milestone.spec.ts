...
describe('Milestone Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 27104 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  describe('trackId', () => {
    it('should forward to milestoneService', () => {
      ...
      vitest.spyOn(service, 'getMilestoneIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.milestonesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
