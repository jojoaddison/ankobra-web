...
describe('ServiceItem Management Delete Component', () => {
  let comp: ServiceItemDeleteDialog;
  let fixture: ComponentFixture<ServiceItemDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ServiceItemDeleteDialog);
