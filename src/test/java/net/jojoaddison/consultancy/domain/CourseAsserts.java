...
public class CourseAsserts {
    ...
    public static void assertCourseUpdatableFieldsEquals(Course expected, Course actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getModuleCount()).as("check moduleCount").isEqualTo(expected.getModuleCount()))
            .satisfies(a -> assertThat(a.getMode()).as("check mode").isEqualTo(expected.getMode()))
            .satisfies(a -> assertThat(a.getLabBased()).as("check labBased").isEqualTo(expected.getLabBased()))
            .satisfies(a -> assertThat(a.getEnrolledCount()).as("check enrolledCount").isEqualTo(expected.getEnrolledCount()))
